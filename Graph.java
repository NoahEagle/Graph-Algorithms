...
public class Graph {
    ...
    /*
     *  A field representing the graph (an array list of hashmaps where the indices represent the
     *  nodes and the hashmaps store each node's neighbor and edge weight to that neighbor as
     *  key and value combos)
     */
    ArrayList<HashMap<Integer, Integer>> theGraph;
    ...
    public Graph(int n) {
        ...
        ArrayList<HashMap<Integer, Integer>> newGraph = new ArrayList<HashMap<Integer, Integer>>(n);
    ...
    public boolean hasEdge(int u, int v) {
        ...
        HashMap<Integer, Integer> uNeighbors = theGraph.get(u);
        
        return uNeighbors.containsKey(v);  
    }
    ...
    public int getWeight(int u, int v) {
        ...
        // hasEdge will collect the potential IAE throwing
        if (!hasEdge(u, v)) {
    ...
    public boolean addEdge(int u, int v, int weight) {
        ...
        // This catches the potential IAE in which u or v doesn't exist via hasEdge
        if (hasEdge(u, v)) {
    ...
    public Set<Integer> outNeighbors(int v) {
        ...
        HashMap<Integer, Integer> vNeighbors = theGraph.get(v);
        
        return vNeighbors.keySet();  
    }
}